...
import net.corda.nodeapi.internal.protonwrapper.netty.createPKIXRevocationChecker
        ...
        override fun createCheck(keyStore: KeyStore, trustStore: KeyStore): Check {
            return object : Check {
                override fun checkCertificateChain(theirChain: Array<javax.security.cert.X509Certificate>) {
                    ...
                    val pkixRevocationChecker = createPKIXRevocationChecker(revocationConfig)
